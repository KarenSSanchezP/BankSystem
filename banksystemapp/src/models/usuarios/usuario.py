...
class Usuario(ABC):
    ...
    def crearUserName(self):
        inicial_nombre = self._nombres.split()[0][0].lower()
        inicial_apellido = self._apellidos.split()[0][0].lower()
        return f"{inicial_nombre}{inicial_apellido}{self._userId}"
...
#Este es el codigo sin refactorizar 
# from abc import ABC, abstractmethod
